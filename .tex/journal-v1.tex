...
\newcommand{\isDraft}[0]{
	\AddToShipoutPictureFG*{%
		\put(30mm,30mm){%
			\rotatebox{45}{\textcolor{red}{\fontsize{100pt}{100pt}\selectfont\fontspec{HYWenHei-85W}\CJKfontspec{HYWenHei-85W}DRAFT}}
		}
	}
}
...
\newcommand{\mininews}[2]{
	% argv: title, content
	\noindent\parbox{\linewidth}{%
		\noindent\parbox{\linewidth}{\Large\fontspec{HYWenHei-75W}\CJKfontspec{HYWenHei-75W}#1}\par\vskip 9pt\nopagebreak
		#2
	}\par\nopagebreak
	\vskip 15pt plus 12pt\nopagebreak
	\hrule\vskip 15pt plus 12pt
}
...
\newcommand{\stdlastpage}[2]{
	...
	\noindent\begin{minipage}{382.5pt}
		...
		任何人和单位可以在非商业使用、不修改的前提下复制、印刷、分发此文档（PDF）。\\
		本文档中少量使用的汉仪文黑字体来自汉仪字库的个人非商用授权，请参考其授权条款以避免侵权。\\
...
\newcommand{\slashsep}[0]{\hskip 11pt/\hskip 11pt}
