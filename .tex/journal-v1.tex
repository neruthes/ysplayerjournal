...
\usepackage[PunctStyle=plain,RubberPunctSkip=false,CJKglue=\hskip 0pt,CJKecglue=\hskip 0.3em plus 3em]{xeCJK}
...
\newcommand{\iarticle}[4]{
	...
	\noindent\parbox{\linewidth}{
		...
		{\LARGE\rmfamily\fontspec{HYWenHei}\CJKfontspec{HYWenHei}\bfseries#2}\par\vskip 3pt\nopagebreak
...
\newcommand{\stdlastpage}[2]{
	...
	\noindent\begin{minipage}{382.5pt}
        ...
        请注意本文档中少量使用的汉仪文黑字体来自汉仪字库的个人非商用授权。\\
        感谢以下字体的开发者：Noto Sans CJK\slashsep Noto Serif CJK\slashsep IBM Plex Sans\slashsep BaskervilleF
        \par
		\vskip 10pt
